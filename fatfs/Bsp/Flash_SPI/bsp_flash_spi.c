...
/**
  ...
  * @retval     状态
  */
W25X_StatusTypeDef W25xx_PowerDown(void)
{
    W25X_CS_L;
    if(W25xx_CMD(W25X_PowerDown) == HAL_OK)
        return W25X_OK;
    W25X_CS_H;
}
...
/**
  ...
  * @retval     状态
  */
W25X_StatusTypeDef W25xx_WakeUp(void)
{
    W25X_CS_L;
    if(W25xx_CMD(W25X_ReleasePowerDown) == HAL_OK)
        return W25X_OK;
    W25X_CS_H;
}
